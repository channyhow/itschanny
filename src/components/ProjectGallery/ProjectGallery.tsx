            ...
            >
              <img
                ...
                style={{
                  ...
                  maxWidth: '450px',
                  transition: 'all 0.5s ease',
                  border: hoveredImage === index ? '1px solid #E2FF00' : '1px solid #A8A8A8',
                }}
              />
            </Button>
            <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', marginTop: '10px' }}>
              ...
              <div>
                <NavLink
                  ...
                  style={{
                    backgroundColor: hoveredButton ? 'rgba(255,255,255,0.85)' : 'rgba(255,255,255,0.5)',
                    padding: '0.75rem 1.5rem',
                    borderRadius: '4px',
                    display: hoveredImage === index ? 'block' : 'none',
                    transition: 'background-color 0.5s ease',
                    boxShadow: hoveredButton ? '2px 2px 5px rgba(0, 0, 0, 0.1)' : 'none',
                  }}
                >
